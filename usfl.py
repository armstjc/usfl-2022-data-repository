...
def get_usfl_schedule(game_jsons: list, save=False):
    ...
    for i in tqdm(game_jsons):
        ...
        game_df["away_team_has_possession"] = data["header"]["leftTeam"][
            "hasPossession"
        ]
        ...
        game_df["home_team_has_possession"] = data["header"]["rightTeam"][
            "hasPossession"
        ]
...
def parse_usfl_player_stats(game_jsons: list, saveResults=False):
    ...
    punting_df["GROSS_PUNT_YDS"] = (
        punting_df["GROSS_PUNT_AVG"] * punting_df["PUNTS"]
    ).astype("int")
        ...
        try:
            for j in data["pbp"]["sections"]:
                ...
                for k in j["groups"]:
                    ...
                    if (
                        off_team_full_name == away_team_full_name
                    ):  # Offense == away team
