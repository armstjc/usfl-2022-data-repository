...
def get_usfl_api_key(key_path=""):
    try:
        ...
        print(
            "The USFL API token was not found in this python environment. " +
            "Attempting to load the API token from a file."
        )
    ...
    try:
        if len(key_path) > 0:
            ...
            raise FileNotFoundError(
                "The USFL API token was not found in your computer."
            )
